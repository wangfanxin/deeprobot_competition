...
## 8. 关键参数（run_smppi_tmppi_cruise_rlstair_tk12.sh 实际值，最新基线）

    S10_NAV_HZ=40 S10_WP_ARRIVE_R=0.2 S10_WP_ADVANCE_DIST=0.5 S10_WP_ALIGN_DB=0.25 S10_WP_ALIGN_OM=0.3
    S10_AUTO_VMAX=4.0 S10_LINE_VMAX=4.0 S10_LINE_YAW_GAIN=2.0 S10_LINE_YAW_MAX=1.0
    S10_LINE_BRAKE_DIST=3.5 S10_LINE_CTE_K=0.4
    ...
    S10_TK_OM_MAX=1.5 S10_TK_VX=1.0 S10_STAIR_APPROACH_VX=1.5
    ...
    S10_POSTSTAIR_HOLD_DIST=0.9 S10_POSTSTAIR_HOLD_VX=1.0 S10_POSTSTAIR_HOLD_T=2.0
    S10_TK2=1 S10_TK2_YAW_DB=0.25 S10_TK2_YAW_K=2.5 S10_TK2_YAW_MAX=1.5 S10_TK2_VX=1.2
    S10_STAIR_WHEEL_CLEAR=-0.02 S10_STAIR_REENTRY_GUARD=1.0 S10_STAIR_EXIT_VX=1.0
    S10_PLAT_VX=2.5 S10_PLAT_OM=0.6
    ...
    S10_CAR_KP_ROLL=150 S10_CAR_KD_ROLL=20 S10_CAR_ROLL_K=0（压弯关闭）
    S10_VMC_Z_DES_OFFSET=0.26
    S10_VMC_YAW_K_WHEEL=80 S10_VMC_OM_ABS_MAX=1.6 S10_VMC_OM_CAP=1.0
