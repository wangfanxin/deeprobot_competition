...
export S10_LINE_YAW_GAIN=2.0 S10_LINE_YAW_MAX=1.0 S10_LINE_BRAKE_DIST=5.0 S10_LINE_CTE_K=0.4
...
export S10_MPPI_ADA=1 S10_MPPI_A_MAX=6.0 S10_MPPI_OMAX=2.5 S10_MPPI_W_GUIDE=1.5 S10_MPPI_W_DIST=2.0 S10_MPPI_W_HEAD=2.0 S10_MPPI_MU=0.36
# 终点代价：到 wp dx=0 位置 + ref_v=0 速度（STOP_DX 内线性生效）
export S10_SMppi_STOP_DX=6.0 S10_MPPI_W_TPOS=10.0 S10_MPPI_W_TV=10.0
