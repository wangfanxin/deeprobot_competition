...
export S10_GLOBAL_FILLET_R=0 S10_WP_ARRIVE_R=0.2 S10_WP_ADVANCE_DIST=0.45
...
export S10_MPPI_ADA=1 S10_MPPI_A_MAX=8.0 S10_MPPI_OMAX=2.5 S10_MPPI_W_GUIDE=1.5 S10_MPPI_W_DIST=2.0 S10_MPPI_W_HEAD=2.0 S10_MPPI_MU=0.36
...
export S10_TURN_SPLIT=1 S10_TURN_ERR_DEG=10 S10_TURN_K=3.0 S10_TURN_OM_MAX=1.5 S10_TURN_V_MAX=4.5 S10_WP_TURN_VX=0.2 S10_TURN_ARRIVE_R=1.5
