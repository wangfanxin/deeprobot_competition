...
export S10_CAR_WHEEL_GF=1.0 S10_VMC_KPH=300 S10_VMC_KDH=60 S10_VMC_WHEEL_K=12.0 S10_VMC_WHEEL_D=0.02 S10_VMC_TERRAIN_LP=0.4 S10_VMC_TERRAIN_LOOKAHEAD=0.6 S10_VMC_TERRAIN_AHEAD_W=0.6 S10_CAR_KP_ROLL=250 S10_CAR_KD_ROLL=30 S10_CAR_ROLL_K=0.05 S10_CAR_ROLL_AMP=0.10 S10_VMC_Z_DES_OFFSET=0.26
