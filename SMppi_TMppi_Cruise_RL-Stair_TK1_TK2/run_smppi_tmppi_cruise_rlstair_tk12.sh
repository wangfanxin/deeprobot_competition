...
export S10_STAIR_SINGLE_RISE=0.10 S10_ELEV_DROP_TH=0.10 S10_DROP_LOOKAHEAD=0.5 S10_DROP_VX=0.3 S10_ELEV_CLIMB_TH=0.2
...
export S10_STAIR_WHEEL_CLEAR=-0.02 S10_STAIR_REENTRY_GUARD=1.0
