...
> 验收（2026-08-20 用户二次更新）：每两航点间 <5s；段直线距离 >5m 放宽至 <10s；整场超时放宽。
...
- **r183-r244 硬门控+ATT 分段（r244 里程碑）**：wp0→15 全通 wp15@90.81。
  - ATT_TMAX 分段：地面拐角(0-6)=80Nm（修 wp3-4 ±π 卡 2.95s），楼梯/平顶(7-12)=40Nm。
  - 硬门控：wp8 两段限速 / wp9 过点后 3m 限 1.5 / wp10 全腿 2.2 / wp12、wp14 大误差限速 /
    wp14/15/16/21/22 跌落沿爬行（wp15-16 0.38m 落沿仍翻，前腿行程不足 pitch>90° 前翻）。
  - 待修超时腿：wp0-1 8.44、wp6-7 15.17、wp9-10 12.20。
...
- **验收**：每两航点间 <5s；段直线距离 >5m 放宽 <10s；整场超时放宽；力矩合规；无侧翻。
