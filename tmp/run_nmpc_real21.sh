#!/bin/bash
# NmpcWbc 闁活亞鍠庣敮顐﹀炊?wp6->7 (v1083: 闁诡厹鍨归ˇ鏌ュ础婵犲啯鏆滈柟?+ 闁哄啰濮靛顖涚缁傜﹪des闂傚嫭鍔曠粻?+ SWING闁告挸绉撮幃娓檔ly + 閻炴稏鍔戝浼存儎缁嬫鍤燞OVER)
...
export S10_NMPC_KP_YAW=6.0 S10_NMPC_KP_POSE_OPP=60 S10_NMPC_YAW_ERR_K=1.5 S10_NMPC_YAW_DIFF=2.0
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real21.npy
