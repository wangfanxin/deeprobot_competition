#!/bin/bash
# NmpcWbc 真原图 wp6->7 (v1085: az_max 6.0 / al_lim 4.0 压低 SWING 期弹跳)
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real16.npy
