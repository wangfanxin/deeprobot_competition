#!/bin/bash
# NmpcWbc 鐪熷師鍥?wp6->7 (v1085: az_max 6.0 / al_lim 4.0 鍘嬩綆 SWING 鏈熷脊璺?
...
export S10_NMPC_AZ_MIN=-4.0 S10_NMPC_AZ_MAX=6.0 S10_NMPC_AL_LIM=4.0
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real17.npy
