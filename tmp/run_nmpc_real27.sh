#!/bin/bash
# NmpcWbc 闂備焦妞挎禍鐐哄窗鎼达絾鏆滄い鎰剁畱閻?wp6->7 (v1083: 闂備浇顕栭崢褰掑垂瑜版崵鍥蓟閵夈儳顢呮繝鐢靛Т閸燁垶寮冲鍫熺厵?+ 闂備礁鎼崯鐗堟叏闂堟侗鐒芥い鏍ㄧ〒椤╅绱掗崒婊愯含des闂傚倸鍊哥€氼參宕濋弴鐘典笉?+ SWING闂備礁鎲￠幐鍝ョ矓閹绢喖绠栨繛鎾寸崲ly + 闂佽崵鍋炵粙蹇涘礉閹存繍鐒藉ù鐓庣摠閸庡海绱掔€ｎ偒鍎ラ柛銈囧殟OVER)
...
export S10_AUTO_LOOKAHEAD_STAIR=3.5 S10_AUTO_CTE_GAIN_STAIR=1.0 S10_AUTO_YAW_GAIN_STAIR=3.0
...
export S10_NMPC_KP_YAW=30.0 S10_NMPC_YAW_ERR_K=1.5 S10_NMPC_YAW_DIFF=2.0
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real27.npy
