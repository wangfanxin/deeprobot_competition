#!/bin/bash
# NmpcWbc 真原图 wp6->7 (v1084: 参数收敛——降速+提前斜坡, pitch FF 3.0, POSE_OPP 60)
...
export S10_STAIR_VX_RAMP=4.0 S10_STAIR_WIN_VX=0.8 S10_STAIR_EXEC_D=1.0
export S10_STAIR_MPPI_OFF_D=0.5 S10_STAIR_CREST_VX=0.8
...
export S10_NMPC_WF=1e-3 S10_NMPC_WM=0.3 S10_NMPC_PITCH_FF_SW=3.0 S10_NMPC_KP_POSE_OPP=60
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real15.npy
