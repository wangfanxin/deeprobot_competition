#!/bin/bash
# NmpcWbc 閻喎甯崶?wp6->7 (v1083: 閹垹顦查崡濠冩暜閹?+ 閺冪姵娼禒绂穇des闂勬劕绠?+ SWING閸撳秴鎮渙nly + 鐞涖劑娼伴惄绋款嚠HOVER)
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real20.npy
