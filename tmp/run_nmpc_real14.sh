#!/bin/bash
# NmpcWbc 真原图 wp6->7 (v1083: 恢复半支撑 + 无条件a_des限幅 + SWING前向only + 表面相对HOVER)
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real14.npy
