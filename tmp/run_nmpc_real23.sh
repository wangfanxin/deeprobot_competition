#!/bin/bash
# NmpcWbc 闂佹椿浜為崰搴ｆ暜椤愶箑鐐?wp6->7 (v1083: 闂佽鍘归崹褰捤囬弻銉ョ濠电姴鍟弳婊堟煙?+ 闂佸搫鍟版慨闈涱焽椤栨稓顩风紒鍌滐躬des闂傚倸瀚崝鏇犵不?+ SWING闂佸憡鎸哥粔鎾箖濞撴獢ly + 闁荤偞绋忛崝鎴濐焽娴煎瓨鍎庣紒瀣儥閸ょ嚍OVER)
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real23.npy
