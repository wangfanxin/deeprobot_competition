#!/bin/bash
# NmpcWbc 真原图 wp6->7 (v1082: HOVER 退出三路兜底 + NMPC 可行性限幅 + swing hipx)
...
export S10_NMPC_WF=1e-3 S10_NMPC_WM=0.3 S10_NMPC_KP_Z=200 S10_NMPC_DEBUG=1 S10_NMPC_HOVER_DROP=0.03 S10_NMPC_PITCH_FF_SW=1.5
export S10_NMPC_HOVER_LEN=0.10 S10_NMPC_HOVER_TMAX=0.5
...
export VMC_TRAJ=/home/wfx/DR_competition/0810new/deeprobot_competition/tmp/traj_nmpc_real13.npy
