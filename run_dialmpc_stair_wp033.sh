...
export S10_AUTO_START_VX=4.5 S10_AUTO_VYAW_MAX=2.0 S10_AUTO_YAW_GAIN=2.5 S10_YAW_DAMP=0.5
...
export S10_RIDGE_PRESCAN=0
export S10_AUTO_MAX_WP=33 S10_TEST_MAX_SIM=600 S10_STUCK_TIMEOUT=90
export S10_NAV_HZ=20
export S10_AUTO_VMAX=4.5 S10_AUTO_LOOKAHEAD=2.0 S10_AUTO_VLIM_LOOKAHEAD=3.0
export S10_AUTO_CTE_MAX=5.0 S10_AUTO_CTE_ERR_GATE=3.0 S10_CTE_GAIN=6.0 S10_AUTO_CTE_GAIN_STAIR=6.0 S10_AUTO_CTE_MAX_STAIR=5.0 S10_AUTO_CTE_ERR_GATE_STAIR=3.0 S10_AUTO_ARRIVE_ERR=0.5
export S10_ELEV_MIN_STEPS=1 S10_ELEV_CLIMB_TH=0.10 S10_ELEV_STEP_TH=0.08 S10_STAIR_MIN_WP=5 S10_STAIR_ENTER_DIST=3.5 S10_ELEV_ENTER=5.0
export S10_LIDAR_WALL=1 S10_MPPI_OBSTACLE=1 S10_MPC_W_OBS=0.1 S10_OBST_LAT_MIN=1.0 S10_OBST_INFLATE=0.15 S10_OBST_H_MIN=0.5
