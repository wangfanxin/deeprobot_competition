...
export S10_AUTO_START_VX=3.8 S10_AUTO_VYAW_MAX=2.0 S10_AUTO_YAW_GAIN=2.5 S10_YAW_DAMP=0.5
...
export S10_AUTO_VMAX=4.0 S10_AUTO_LOOKAHEAD=2.0 S10_AUTO_VLIM_LOOKAHEAD=3.0
export S10_AUTO_CTE_MAX=2.0 S10_AUTO_CTE_ERR_GATE=1.2 S10_CTE_GAIN=5.0 S10_AUTO_CTE_GAIN_STAIR=6.0 S10_AUTO_CTE_MAX_STAIR=5.0 S10_AUTO_CTE_ERR_GATE_STAIR=3.0 S10_AUTO_ARRIVE_ERR=0.5
export S10_ELEV_MIN_STEPS=1 S10_ELEV_CLIMB_TH=0.10 S10_ELEV_STEP_TH=0.08 S10_STAIR_ENTER_DIST=3.5 S10_ELEV_ENTER=5.0
